...
def main():
    ...
    model.load_adapter("/home/zp489/scratch/working/v1/2010/06_adapter_fusion/run2_mnli/mnli", "text_task", config=PfeifferConfig(), with_head=False)
    model.load_adapter("/home/zp489/scratch/working/v1/2010/06_adapter_fusion/run3_mrpc/mrpc", "text_task", config=PfeifferConfig(), with_head=False)
